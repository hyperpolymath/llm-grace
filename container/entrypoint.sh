...
# llm-grace container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping llm-grace..."
...
# Examples:
#   exec /app/llm-grace
#   exec /app/release/bin/llm-grace start
#   exec /app/llm-grace serve --host "${APP_HOST}" --port "${APP_PORT}"
