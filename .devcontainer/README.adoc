...
= Dev Container Usage
:author: Jonathan Jewell <j.d.a.jewell@open.ac.uk>
...
Replace `llm-grace` placeholders in both `devcontainer.json` and `Containerfile` with your actual project name. Run `just deps` to verify the environment after first launch.
